...
public class StudentTests {
    ...
    @Test
    public void testingStuffYe() throws InvalidBalanceException, EmptyTreeException {
      
    
        AVLGTree<Integer> t = new AVLGTree<>(1); 
         AVLGTree<Integer> w = new AVLGTree<>(1); 
       ...
       // w.insert(100);
        w.printList();
        System.out.println("Count: " + w.getCount() + " Height: " + w.getHeight());
        System.out.println(w.isAVLGBalanced());
        System.out.println(w.isBST());
    }
